...
if (isset($_GET['buscar'])) {
  ...
  if (isset($_GET['nitEmpr'])) {
    ...
    echo json_encode([
      'id' => is_null($id) ? 0 : $id, 'documento' => is_null($documento) ? '' : $documento, 'nombres' => is_null($nombres) ? '' : $nombres, 'razonSocial' => is_null($razonSocial) ? '' : $razonSocial, 'razonSocial2' => is_null($razonSocial2) ? '' : $razonSocial2, 'razonSocial3' => is_null($razonSocial3) ? '' : $razonSocial3, 'activEcon' => is_null($activEcon) ? '' : $activEcon, 'direccDomic' => is_null($direccDomic) ? '' : $direccDomic, 'ciudad' => is_null($ciudad) ? '' : $ciudad, 'email' => is_null($email) ? '' : $email, 'telocel1' => is_null($telocel1) ? '' : $telocel1, 'telocel2' => is_null($telocel2) ? '' : $telocel2, 'ctde' => is_null($ctde) ? '' : $ctde, 'dp' => is_null($dp) ? '' : $dp, 'forme' => is_null($forme) ? '' : $forme, 'forte' => (is_null($forte) || $forte == 0) ? '' : $forte, 'solicitud' => is_null($solicitud) ? '' : $solicitud, 'activEconEmpr' => is_null($activEconEmpr) ? '' : $activEconEmpr, 'direccEmpr' => is_null($direccEmpr) ? '' : $direccEmpr, 'emailPersonalEmpr' => is_null($emailPersonalEmpr) ? '' : $emailPersonalEmpr, 'emailEmpr' => is_null($emailEmpr) ? '' : $emailEmpr, 'apellidos' => is_null($apellidos) ? '' : $apellidos, 'telocel' => is_null($telocel) ? '' : $telocel
    ]);
    mysqli_stmt_close($stmt);
  } elseif (isset($_GET['documento'])) {
    $apellido1 = $apellido2 = '';
    $cons .= ', apellido1, apellido2 FROM diligencias_new WHERE documento = ?';
    $stmt = mysqli_prepare($conn, $cons);
    ...
    mysqli_stmt_fetch($stmt);
    echo json_encode([
      'id' => is_null($id) ? 0 : $id, 'nombres' => is_null($nombres) ? '' : $nombres, 'razonSocial' => is_null($razonSocial) ? '' : $razonSocial, 'razonSocial2' => is_null($razonSocial2) ? '' : $razonSocial2, 'razonSocial3' => is_null($razonSocial3) ? '' : $razonSocial3, 'activEcon' => is_null($activEcon) ? '' : $activEcon, 'direccDomic' => is_null($direccDomic) ? '' : $direccDomic, 'ciudad' => is_null($ciudad) ? '' : $ciudad, 'email' => is_null($email) ? '' : $email, 'telocel1' => is_null($telocel1) ? '' : $telocel1, 'telocel2' => is_null($telocel2) ? '' : $telocel2, 'ctde' => is_null($ctde) ? '' : $ctde, 'dp' => is_null($dp) ? '' : $dp, 'forme' => is_null($forme) ? '' : $forme, 'forte' => (is_null($forte) || $forte == 0) ? '' : $forte, 'solicitud' => is_null($solicitud) ? '' : $solicitud, 'apellido1' => is_null($apellido1) ? '' : $apellido1, 'apellido2' => is_null($apellido2) ? '' : $apellido2
    ]);
    mysqli_stmt_close($stmt);
  }
  mysqli_close($conn);
...
if (isset($_POST['regAct'])) {
  ...
  if ($_POST['idSolicitud'] == 0) {
    $cons = 'INSERT INTO diligencias_new (tipoDocumento, documento, nombres, razonSocial,razonSocial2,razonSocial3, activEcon, direccDomic, ciudad, email, telocel1, telocel2, ctde, dp, forme, forte, solicitud, ';
    ...
    $cons = 'UPDATE diligencias_new SET tipodocumento = ?, documento = ?, nombres = ?, razonSocial= ?, razonSocial2= ?, razonSocial3= ?, activEcon = ?, direccDomic = ?, ciudad = ?, email = ?, telocel1 = ?, telocel2 = ?, ctde = ?, dp = ?, forme = ?, forte = ?, solicitud = ?, ';
    if ($_POST['tipoDocumento'] == 2) {
