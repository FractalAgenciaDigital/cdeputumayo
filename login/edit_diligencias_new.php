...
if (isset($_POST['update'])) {
	...
	// $edit_diligencias_new = "UPDATE `diligencias_new` SET `tipoDocumento` = '2', `documento` = '7727678', `nombres` = 'WILLIAM ALBERTOO', `apellidos` = 'ARROLLO VELAZQUE ', `ciudad` = 'ORITO', `email` = 'csigourmetsas@hotmail.com', `celular` = '', `razonSocial` = 'C.S.I GOURMET S.A.S', `nitEmpr` = '901104974', `direccEmpr` = 'CL 3 CA N 5', `activEcon` = 'Supermercados - Tiendas - Autoservicios - Minimercados', `otro_activEcon` = '4644 Comercio al por mayor de aparatos y equipo de uso doméstico', `des_productivo` = '', `fort_empresarial` = '', `form_empresarial` = '', `nombre_representante` = '', `celular_representante` = '', `email_representante` = 'csigourmetsas@hotmail.com csigourmetsas@hotmail.com', `poblacion` = 'Ninguna', `otro_poblacion` = 'Ninguna', `fecha_matricula` = '2021-08-10', `matricula` = '', `registrado` = 'No', `num_cam_comercio` = '', `programa_ccp` = 'No', `estado_solicitud` = 'En proceso', `fecha_solicitud` = '2020-09-12', `genero` = '', `escolaridad` = 'Ninguna', `rango_edad` = '18 a 24 años', `solicitud` = 'Solicito mas informaciÃ³n ' WHERE `diligencias_new`.`id_diligencia` = 3671";
