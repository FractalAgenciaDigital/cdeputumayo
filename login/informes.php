<?php
		...
		$ND = getDate();
		$C1="";		if($ND['mon']<10) $C1="0";
		$C2="";		if($ND['mday']<10) $C2="0";
        ...
        <table class="table table-responsive table-bordered table-striped table-sm" style="font-size: 12px;">
          <thead>
            <tr>
              ...
              <th class="text-center align-middle">DireccEmpr</th>
              <th class="text-center align-middle">ActivEcon</th>
              ...
              <th class="text-center align-middle">Poblacion</th>
              ...
              <th class="text-center align-middle">Num Camara Comercio</th>
...
<script>
    ...
    function listar()
    {
		let cuerpo = {listar : '1', tipoDoc: $('#tipoDoc').val(), txtBuscar: $('#txtBuscar').val(), fechaDesde: $("#fechaDesde").val(), fechaHasta: $("#fechaHasta").val()};
