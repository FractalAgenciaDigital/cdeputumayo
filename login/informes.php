...
<script>
	function ruta() {
		document.getElementById("btn_export").href = "informe.php?tipoDocumento=" + document.FORMA.tipoDoc.value + "&txtBuscar=" + document.FORMA.txtBuscar.value + "&fechaDesde=" + document.FORMA.fechaDesde.value + "&fechaHasta=" + document.FORMA.fechaHasta.value;
	}
</script>
<div class="row">
	<div class="col-sm-12">
			...
			<div class="card-body">
				<form name="FORMA">
					<div class="form-group row">
						...
						<label class="col-md-2 col-form-label">Tercero o Razózn social</label>
						<div class="col-md-3">
