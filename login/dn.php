        ...
        <div class="container bg-white mb-4">
            ...
            <div class="form-row">
                <div class="form-group col-3">
                    ...
                    <select v-model="tipoDocumento" required="" name="tipoDocumento" id="tipoDocumento" class="form-control">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="text" name="documento" required="" v-model="documento" id="documento" class="form-control" placeholder="Documento">
                </div>
                <!-- <div class="form-group col-3">
          ...
          <input type="text" name="nitEmpr" v-model="nitEmpr" id="nitEmpr" class="form-control" placeholder="NIT">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="text" v-model="nombres" id="nombres" name="nombres" class="form-control">
                </div>
                <div class="form-group col-3">
                    <label for="apellidos">Apellidos</label>
                    <input type="text" v-model="apellidos" id="apellidos" name="apellidos" class="form-control" placeholder="Apellidos">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="number" id="celular" name="celular" v-model="celular" class="form-control" placeholder="Celular">
                </div>
                <div class="form-group col-md-3">
                    <label for="activEcon">Act. Económica:</label>
                    <input type="text" id="activEcon" v-model="activEcon" name="activEcon" class="form-control" placeholder="example" aria-label="ActEconómica">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-3">
                    ...
                    <input type="text" id="des_productivo" name="des_productivo" class="form-control" placeholder="example" aria-label="DesProductivo">
                </div>
                <div class="form-group col-3">
                    <label for="princ_prod_serv">Principal Prod/Serv:</label>
                    <input type="text" id="princ_prod_serv" name="princ_prod_serv" class="form-control" placeholder="Principal Prod/Serv" aria-label="PrincipalProd/Serv">
                </div>
                <div class="form-group col-3">
                    <label for="fort_empresarial">Fortalecimiento Empresarial</label>
                    <input type="text" id="fort_empresarial" name="fort_empresarial" class="form-control" placeholder="Fortalecimiento Empresarial" aria-label="fort_empresarial">
                </div>
                <div class="form-group col-3">
                    <label for="form_empresarial">Formación Empresarial:</label>
                    <input type="text" id="form_empresarial" name="form_empresarial" class="form-control" placeholder="Formación Empresarial" aria-label="form_empresarial">
                </div>
            </div>
            ...
            <div class="form-row ">
                <div class="form-group col-3">
                    ...
                    <input type="text" v-model="nombre_representante" name="nombre_representante" id="nombre_representante" class="form-control" placeholder="Nombre Completo">
                </div>
                <div class="form-group col-3">
                    <label for=fecha_matricula">Fecha Matricula:</label>
                    <input class="form-control" type="date" v-model="fecha_matricula" name="fecha_matricula" id="fecha_matricula" value="<?= $fecha_matricula ?>">
                </div>
                <!-- ---------------------------------------------- -->
                ...
                <div class="form-group col-3 aux_cual" style="display:none">
                    ...
                    <input class="form-control" type="text" placeholder="Escriba su tipo de población" name="otro_poblacion" value="<?= (isset($otro_poblacion) && $otro_poblacion == "Otro") ?>">
                </div>
            </div>
            <!-- ------------------------------------- -->
            <!-- ------------------------------------- -->
            ...
            <div class="form-row">
                <div class="form-group col-3">
                    ...
                    <input type="text" v-model="email_representante" name="email_representante" id="email_representante" class="form-control" placeholder="Email Representante">
                </div>
                <div class="form-group col-3">
                    <label for="matricula" id="matricula" name="matricula">Número Matricula:</label>
                    <input class="form-control" type="text" placeholder="matricula" name="matricula" v-model="matricula" id="matricula">
                </div>
                ...
                <div class="form-group col-3 aux_regis " style="display:none">
                    ...
                    <input class="form-control" type="text" placeholder="Número C. de Comercio:" name="num_cam_comercio" id="num_cam_comercio" v-model="num_cam_comercio" value="<?= $num_cam_comercio ?>">
                </div>
            </div>
            <!-- --------------------------------------------------- -->
            <!-- 
          ...
          <input class="form-control" type="text" placeholder="Número cámara comercio" name="registrado" id="registrado" value="<?= $registrado ?>">
            ...
            <d class="form-row">
                <div class="form-group col-3">
                    ...
                    <input type="number" v-model="celular_representante" id="celular_representante" name="celular_representante" class="form-control" placeholder="Celular Representante">
                </div>
...
if (isset($_POST['registrar'])) {
    ...
    $consulta = "INSERT INTO diligencias_new (`id`, `tipoDocumento`, `documento`, `nombres`, `apellidos`, `ciudad`, `email`, `celular`, `activEcon`, `des_productivo`, `princ_prod_serv`, `fort_empresarial`, `form_empresarial`, `nombre_representante`, `celular_representante`, `email_representante`, `poblacion`, `otro_poblacion`, `fecha_matricula`, `matricula`, `registrado`, `num_cam_comercio`, `programa_ccp`, `estado_solicitud`, `fecha_solicitud`) VALUES ('$id', '$tipoDocumento','$documento','$nombres','$apellidos','$ciudad','$email','$celular','$activEcon','$des_productivo','$princ_prod_serv','$fort_empresarial','$form_empresarial','$nombre_representante','$celular_representante','$email_representante','$poblacion','$otro_poblacion','$fecha_matricula' ,'$matricula','$registrado','$num_cam_comercio','$programa_ccp','$estado_solicitud','$fecha_solicitud')";
    /* $consulta = mysqli_query($conn, "INSERT INTO diligencias_new(id, tipoDocumento, documento, nombres, apellidos, ciudad, email, celular, activEcon, des_productivo, princ_prod_serv, fort_empresarial, form_empresarial, nombre_representante, celular_representante, email_representante, fecha_matricula, matricula, registrado, num_cam_comercio, programa_ccp, estado_solicitud, fecha_solicitud, create_at, updated_at) values
        ('" . $_POST['
          tipoDocumento '] . "', '" . $_POST['
          documento '] . "', '" . $_POST['
          nombres '] . "', '" . $_POST['
          ...
          celular '] . "', '" . $_POST['
          activEcon '] . "', '" . $_POST['
          des_productivo '] . "', '" . $_POST['
          princ_prod_serv '] . "', '" . $_POST['
          fort_empresarial '] . "', '" . $_POST['
          form_empresarial '] . "', '" . $_POST['
          nombre_representante '] . "', '" . $_POST['
          celular_representante '] . "', '" . $_POST['
          email_representante '] . "', '" . $_POST['
          fecha_matricula '] . "', '" . $_POST['
          matricula '] . "', '" . $_POST['
          registrado '] . "', '" . $_POST['
          num_cam_comercio '] . "', '" . $_POST['
          programa_ccp '] . "', '" . $_POST['
          estado_solicitud '] . "', '" . $_POST['
          fecha_solicitud '] . "', '" . $_POST['
          create_at '] . "', '" . $_POST['
          updated_at '] . "')
        "); */
...
//   $query = mysqli_query($conn, "INSERT INTO diligencias_new(id, tipoDocumento, documento, nitEmpr, nombres, apellidos, ciudad, email, celular, activEcon, des_productivo, princ_prod_serv, fort_empresarial, form_empresarial, nombre_representante, celular_representante, email_representante, fecha_matricula, matricula, registrado, num_cam_comercio, programa_ccp, estado_solicitud, fecha_solicitud, create_at, updated_at) values
//       ('" . $_POST['
//         tipoDocumento '] . "', '" . $_POST['
//         documento '] . "', '" . $_POST['
//         nitEmpr '] . "', '" . $_POST['
