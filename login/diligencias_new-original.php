...
if (isset($_POST['Guardar'])) {
  ...
  $aux_fec_sol = '';
  $aux_fec_sol1 = '';
  if ($_POST['fecha_solicitud'] != '') {
    $aux_fec_sol = ",'" . $_POST['fecha_solicitud'] . "'";
    $aux_fec_sol1 = ", fecha_solicitud";
  }
  $enero = 'null';
  $febrero = 'null';
  $marzo = 'null';
      ...
      <div class="form-row">
        <div class="form-group col-3">
          ...
          <select class="form-control" name="poblacion" id="poblacion" onChange="tipoPobla(this.value)">
            <option value="Ninuna" <?php if ($poblacion == "Ninuna") {
                                      echo "selected";
                                    } ?>>Ninguno</option>
            <option value="Desplazado" <?php if ($poblacion == "Desplazado") {
                                          echo "selected";
                                        } ?>>Desplazado</option>
            <option value="Afrocolombiano" <?php if ($poblacion == "Afrocolombiano") {
                                              echo "selected";
                                            } ?>>Afrocolombiano</option>
            <option value="Indigena" <?php if ($poblacion == "Indigena") {
                                        echo "selected";
                                      } ?>>Indígena</option>
            <option value="Victima" <?php if ($poblacion == "Victima") {
                                      echo "selected";
                                    } ?>>Victima</option>
            <option value="Cabeza de Familia" <?php if ($poblacion == "Cabeza de Familia") {
                                                echo "selected";
                                              } ?>>Cabeza de Familia</option>
            <option value="Condicion Discapacidad" <?php if ($poblacion == "Condicion Discapacidad") {
                                                      echo "selected";
                                                    } ?>>Condición Discapacidad</option>
            <option value="Otro" <?php if ($poblacion == "Otro") {
                                    echo "selected";
                                  } ?>>Otro</option>
          </select>
        </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-3">
          ...
          <select class="form-control" style="width: 5em;" name="programa_ccp" id="programa_ccp" onChange="cpp(this.value)">
            <option value="No" <?php if ($programa_ccp == "No") {
                                  echo "selected";
                                } ?>>No</option>
            <option value="Si" <?php if ($programa_ccp == "Si") {
                                  echo "selected";
                                } ?>>Si</option>
          </select>
        </div>
      ...
      <div class="form-row">
        <div class="form-group col-3">
          ...
          <select class="form-control aux_program" name="estado_solicitud" id="estado_solicitud">
            <option value="En proceso" <?php if ($estado_solicitud == "En proceso") {
                                          echo "selected";
                                        } ?>>En proceso</option>
            <option value="Resuelta" <?php if ($estado_solicitud == "Resuelta") {
                                        echo "selected";
                                      } ?>>Resuelta</option>
          </select>
        </div>
