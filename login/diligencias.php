				...
				<table class="table table-responsive table-bordered table-striped table-sm" style="font-size: 12px; max-height: 425px;">
					<thead>
						<tr>
							...
							<th class="" style="background:white; border: 2px;right: 46px;position: sticky;" colspan="1"></th>
							<th class="" style="background:white; border: 2px;right: 0; position: sticky;" colspan="1"></th>
						</tr>
					</thead>
					<tbody id="cuerpo">
