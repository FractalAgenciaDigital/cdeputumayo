...
if (isset($_POST['listar'])) {
    $cons = 'SELECT tipoDocumento, documento, nombres, apellidos, ciudad, email, celular, razonSocial, nitEmpr,direccEmpr, activEcon, otro_activEcon, des_productivo, fort_empresarial, form_empresarial, nombre_representante, celular_representante, email_representante, poblacion, otro_poblacion, fecha_matricula, matricula, registrado, programa_ccp, estado_solicitud, fecha_solicitud, genero, escolaridad, rango_edad, solicitud FROM diligencias_new';
    $donde = '';
